...
class StockQuantityHistory(models.TransientModel):
    ...
    z_parent_id = fields.Many2one('product.category', 'Parent Category', index=True,store = True,ondelete='cascade')
    ...
    def open_table(self):
        ...
        if self.compute_at_date:
            ...
            action = {
                ...
                'domain': ['|',('type', '=', 'product'),'&',('qty_available', '!=', 0),('z_parent_id','=',self.z_parent_id.id)],
