...
class AccountStandardLedgerLines(models.TransientModel):
    ...
    z_sale_team = fields.Many2one('crm.team',string='Sale Team',compute='get_sale_details',store='True')
    z_sale_person = fields.Many2one('res.users',string='Saleperson',compute='get_sale_details',store='True')
    z_sale_office = fields.Many2one('office.name',string='Sale Office',compute='get_sale_details',store='True')
