...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            round_off_account=int(ICPSudo.get_param('tds_calculation.round_off_account')),
        )
        return res
    ...
    def set_values(self):
        ...
        ICPSudo = self.env['ir.config_parameter'].sudo()
        ICPSudo.set_param("tds_calculation.round_off_account", self.round_off_account.id)
